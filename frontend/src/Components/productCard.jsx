...
function ProductCard({ description, price, photo, title }) {
  return (
    <div className="flex flex-row h-24 w-80 items-center border-4 border-cyan-500 bg-cyan-50 rounded-md shadow-lg shadow-cyan-500/100  mt-3 mx-10 hover:shadow-green-500/100 hover:border-green-500">
